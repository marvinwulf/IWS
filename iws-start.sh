...
tmux send-keys -t iws-main-session:0.0 "source /root/.iws/bin/activate && cd /root/.iws/IWS-main/ && python3 handle.py" C-m

tmux send-keys -t iws-main-session:0.1 "source /root/.iws/bin/activate && cd /root/.iws/IWS-main/ && python3 main.py" C-m

tmux send-keys -t iws-main-session:0.2 "cd /root/.iws/IWS-main/localserver" C-m
tmux send-keys -t iws-main-session:0.2 "node server.js" C-m
